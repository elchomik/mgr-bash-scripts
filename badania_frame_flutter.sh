...
do
	...
	then
		...
		if [ -n "$result" ]; then
			...
			echo $wynik >> ~/Desktop/wyniki/wyniki_flutter/wyniki_frame/dane_szczegolowe_$1.txt
		fi
	else
...
echo $srednie_wynik_user >> ~/Desktop/wyniki/wyniki_flutter/wyniki_frame/dane_srednie_$1.txt
